...
const items = [
    { 
     ...
     },
     {
      ...
      links:[
        {
          Certificate: "https://www.credly.com/badges/61039e48-7c36-40dc-81f2-77028c4d2e38?source=linked_in_profile"
        }
      ],
    ...
    },
    {
      ...
      links:[{
        Certificate:"https://www.credential.net/12caeaf1-f086-484d-917b-e1fff3c93690"
      },
      ],
   ...
   },
   {
    ...
    links: [
      {
        Certificate:"https://www.coursera.org/account/accomplishments/specialization/3XNBA9FRCGNL" 
      }
    ],
    img: "https://dbl9c3jtrxi8u.cloudfront.net/python_for_everybody2.png",
    description: "A Coursera specialization by the University of Michigan, covering the fundamentals of Python. Topics included data structures, web data access, databases with Python, and data visualization.",
  }
];
